...
HF_TOKEN='your huggingface token' MINIO_ACCESS_KEY='minio' MINIO_SECRET_KEY='minio123' MINIO_ENDPOINT=$(oc get route minio-api -ojson | jq '.spec.host') python minio/download_llms.py
deactivate
```
